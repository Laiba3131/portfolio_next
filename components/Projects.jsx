        ...
        <section className="w-full py-20 px-6 md:px-10 lg:px-20 bg-[#031B2E] text-white">
            <div className="max-w-7xl mx-auto">
                <div className="mb-16 text-center md:text-left">
                    <span className="text-blue-500 font-medium tracking-widest text-sm uppercase">My Portfolio</span>
                    <h2 className="text-4xl md:text-5xl font-bold mt-2">Recent <span className="text-blue-500">Projects</span></h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, index) => (
                        <div key={index} className="group bg-[#0A192F] rounded-2xl overflow-hidden hover:-translate-y-2 transition duration-300 border border-gray-800 hover:border-blue-500/50 flex flex-col h-full">
                            {/* Image Container */}
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                <h3 className="text-2xl font-bold mb-3 group-hover:text-blue-400 transition">{project.title}</h3>
                                ...
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {project.tech.map((tech, i) => (
                                        <span key={i} className="text-xs font-semibold px-3 py-1 bg-blue-500/10 text-blue-400 rounded-full border border-blue-500/20">
                                            {tech}
                                        </span>
                                    ))}
                                </div>
                                ...
                                <div className="flex gap-4 mt-auto">
                                    <a href={project.liveLink} className="flex-1">
                                        <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg group-hover:shadow-lg hover:shadow-blue-500/25 transition-all">
                                            <ExternalLink className="mr-2 h-4 w-4" /> Live Demo
                                        </Button>
                                    </a>
                                    <a href={project.sourceLink} className="flex-1">
                                        <Button variant="outline" className="w-full border-gray-600 text-gray-300 hover:text-white hover:bg-gray-800 hover:border-gray-500 bg-transparent rounded-lg">
