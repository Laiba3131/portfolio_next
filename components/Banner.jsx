...
function Banner() {
  ...
  return (
    <>
      <div
        id="home"
        className="pb-8 lg:pb-0 px-6 md:px-10 lg:px-20 min-h-screen pt-22 w-full banner-wrapper"
      >
        <div className="pt-20 lg:pt-0 grid lg:grid-cols-2 grid-cols-1 h-full items-center ">
          ...
          <div className="order-2 lg:order-1 pt-10 lg:pt-0">
            ...
            >
              <span className="lg:text-[70px] md:text-[40px] text-[30px]">
                Hey! I am{" "}
              </span>
              <span className="gold-text-gradient">Laiba</span>
            </motion.h1>
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <Link
                ...
                className="bg-black/50 p-3 border border-[#B18325]/50 text-[#B18325] rounded-full hover:bg-[#B18325] hover:text-black transition-all duration-300"
              >
